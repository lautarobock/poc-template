define([], function() {
    ...
    return {
            'es': {
                ...
                'content.breweries': 'Cervecerias',
                'content.vintage': 'Bodega Vintage',
                ...
                'stats.drunksBeer': 'Cervezas Tomadas',
                'stats.califications': 'Calificaciones Realizadas',
                'stats.uniqueBeers': 'Cervezas Diferentes',
                'stats.strongestBeer': 'Cerveza con mas alcohol',
                'stats.weakerBeer': 'Cerveza con menos alcohol',
                'stats.topRating': 'La cerveza con mejor rating',
                'stats.worstRating': 'La cerveza con peor rating',
                'stats.brewery.amount': 'Cantidad de cervecerias',
                'stats.chart.beerPerMonth': 'Cervezas por mes',
                ...
                'brewery.data.locations': 'Ubicaciones',
                ...
                'brewery.data.location.address.administrative_area_level_2': 'Area nivel 2',
                ...
                'vintage.new': 'Nuevo ingreso en bodega',
                'vintage.data.title': 'Titulo',
                'vintage.data.bottling': 'Embotellada (Exacta)',
                'vintage.data.expiration': 'Vencimiento (Exatcto)',
                'vintage.data.entry': 'Ingreso (Exatcto)',
                'vintage.left.title': 'Botellas Restantes',
                'vintage.form.vintageData': 'Añejamiento',
                'vintage.data.windowStart': 'Inicio ventana optima',
                'vintage.data.windowEnd': 'Fin ventana optima',
                'vintage.data.expectation': 'Expectativas de añejamiento',
                'vintage.data.expectation.help': 'Ingresa cuales son las expectativas y objetivos con el añejamiento de esta cerveza',
