define([], function() {
    ...
    return {
            'es': {
                ...
                'beer.data.score.overall': 'Percentil 100 sobre el total de cervezas',
                'beer.data.score.style': 'Percentil 100 sobre el total de cervezas del mismo estilo BJCP',
                'beer.data.score.category': 'Percentil 100 sobre el total de cervezas de la misma categoria BJCP',
